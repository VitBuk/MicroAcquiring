...
public class Transactions {
    ...
    private static void generateHistory() {
        ...
        transaction1.setLocalDate(LocalDate.of(2015, Month.NOVEMBER, 1));
        ...
        transaction2.setStatus(Transaction.Status.CANCEL);
        transaction2.setLocalDate(LocalDate.of(LocalDate.now().getYear(),
        ...
        transaction3.setLocalDate(LocalDate.of(2015, Month.NOVEMBER, 17));
        ...
        transaction4.setLocalDate(LocalDate.of(2015, Month.NOVEMBER, 10));
        ...
        transaction5.setLocalDate(LocalDate.of(1970, Month.AUGUST, 20));
